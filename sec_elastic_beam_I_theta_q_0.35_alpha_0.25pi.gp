...
plot file1 using 1:(strcol(3) eq "#" ? 1/0 : $3) with points pointsize 0.5 pointtype 7 lc rgb "red" title sprintf('q=%.2f, {/symbol a}=%.3fπ', q, alpha/pi), \
     file2 using 1:(strcol(3) eq "#" ? 1/0 : $3) with points pointsize 0.5 pointtype 7 lc rgb "red" title "" , \
...
# Plot the figure
plot file3 using 3:4 with lines linewidth 2 lc rgb "blue" title "first arm (move)",\
     file4 using 3:4 with lines linewidth 2 lc rgb "orange" title "second arm (move)"
...
# Plot the figure  
plot file3 every 5::1 using 3:4:(column(11)*scale):(column(12)*scale) with vectors head nofilled size screen 0.02,15,45 lw 2 lc "red" title "10*traction f (first arm)" , \
     file3 using 3:4 with lines linewidth 2 lc rgb "blue" title "first arm (move)" , \
     file4 every 15::1 using 3:4:(column(11)*scale):(column(12)*scale) with vectors head nofilled size screen 0.02,15,45 lw 2 lc "purple" title "10*traction f (second arm)" , \
     file4 using 3:4 with lines linewidth 2 lc rgb "orange" title "second arm (move)"
...
# Plot the figure  
plot file3 every 5::1 using 3:4:13:14 with vectors head nofilled size screen 0.02,15,45 lw 2 lc "red" title "U-inf (first arm)" , \
     file3 using 3:4 with lines linewidth 2 lc rgb "blue" title "first arm (move)" , \
     file4 every 15::1 using 3:4:13:14 with vectors head nofilled size screen 0.02,15,45 lw 2 lc "purple" title "U-inf (second arm)" , \
     file4 using 3:4 with lines linewidth 2 lc rgb "orange" title "second arm (move)"
