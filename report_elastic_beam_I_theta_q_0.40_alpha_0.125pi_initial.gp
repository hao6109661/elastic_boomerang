...
# Set the output file 
set output sprintf("RESLT_q_%.3f_alpha_%.3fpi_plot/initial_combine_elastic_beam_I_theta_q_%.3f_alpha_%.3fpi_initial_%.2f_%d.png", q, alpha/pi, q, alpha/pi, initial1, i)
...
set arrow 2 from 0.01, graph 0 to 0.01, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
#set arrow 3 from 0.001, graph 0 to 0.001, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 4 from 0.0001, graph 0 to 0.0001, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 5 from 0.0005, graph 0 to 0.0005, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 6 from 0.004, graph 0 to 0.004, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 7 from 0.0015, graph 0 to 0.0015, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 8 from 0.0002, graph 0 to 0.0002, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
...
set xtics("0.0001" 0.0001, "0.0002" 0.0002, "0.0005" 0.0005, "0.0015" 0.0015, "0.004" 0.004, "0.01" 0.01)
...
set tics
set xtics ("-1" -1, "" -0.75, "-0.5" -0.5, "" -0.25, "0" 0)
...
set origin 0.54,0.25
}

set origin 0.54, 0.49
do for [i=3:4] {
plot for [file in filelist[i]] \
             file using 3:4 with lines linewidth 3 lt 5-i title ""
...
set origin 0.67,0.16
}

set origin 0.67, 0.35
do for [i=3:4] {
plot for [file in filelist[i]] \
             file using 3:4 with lines linewidth 3 lt i-2 title ""
