...
# Set the output file 
set output sprintf("RESLT_q_%.3f_alpha_%.3fpi_plot/combine_elastic_beam_I_theta_q_%.3f_alpha_%.3fpi_initial_%.2f_%d.png", q, alpha/pi, q, alpha/pi, initial1, i)
...
set arrow 3 from 0.02, graph 0 to 0.02, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 4 from 0.03, graph 0 to 0.03, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 5 from 0.04, graph 0 to 0.04, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
set arrow 6 from max_value, graph 0 to max_value, graph 1 nohead lc rgb "black" dashtype 2 lw 1.3 front
...
set origin 0.24,0.17
}

set origin 0.24, 0.37
do for [i=3:4] {
plot for [file in filelist[i]] \
...
i=1
plot for [file in filelist[i]] \
             file using 3:4 with lines linewidth 3 lc "black" title ""
...
set origin 0.53,0.14
}

set origin 0.53, 0.21
do for [i=3:4] {
plot for [file in filelist[i]] \
             file using 3:4 with lines linewidth 3 lt i-2 title ""
...
set origin 0.64, 0.17
do for [i=2:2] {
plot for [file in filelist[i]] \
             file using 3:4 with lines linewidth 3 lc "brown" title ""
             
plot for [file in filelist[i+counter_branch+1]] \
             file using 3:4 with lines linewidth 3 lc "brown" title ""
}

set origin 0.64, 0.27
do for [i=3:3] {
plot for [file in filelist[i]] \
             file using 3:4 with lines linewidth 3 lt i-1 title ""
