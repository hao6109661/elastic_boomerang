...
# Set the output file 
set output sprintf("RESLT_q_%.3f_alpha_%.3fpi_plot/limit2_combine_elastic_beam_I_theta_q_%.3f_alpha_%.3fpi_initial_%.2f_%d.png", q, alpha/pi, q, alpha/pi, initial1, i)
