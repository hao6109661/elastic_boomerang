...
#ffmpeg -framerate $framerate -i "compare_combine_elastic_beam_I_theta_q_${q}_alpha_${alpha_without_pi}pi_stable_I_max_0.02_%d.png" -c:v libx264 -r $framerate -pix_fmt yuv420p first.mp4
...
#ffmpeg -framerate $framerate -i "compare_combine_elastic_beam_I_theta_q_${q}_alpha_${alpha_without_pi}pi_unstable_I_max_0.02_%d.png" -c:v libx264 -r $framerate -pix_fmt yuv420p second.mp4
...
#ffmpeg -f concat -safe 0 -i filelist.txt -c copy compare_combine_elastic_beam_I_theta_q_${q}_alpha_${alpha_without_pi}pi_four_branches_I_max_0.02.mp4
